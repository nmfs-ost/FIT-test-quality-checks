...
- [ ] Installation instructions that the reviewer can run. Reviewer, please try installing and only check off if install is verified. If this is a web app or other type of software that does not require installation, check this off.
